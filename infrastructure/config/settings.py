...
CONFIG_RAG_ENABLED = "rag_enabled"                # RAG 是否开启
CONFIG_RAG_AUTO_INDEX = "rag_auto_index"          # 是否自动索引
CONFIG_RAG_QUERY_MODE = "rag_query_mode"          # 默认检索模式
CONFIG_RAG_REMEMBER_STATE = "rag_remember_state"  # 记住上次 RAG 状态
...
# 经验值：英文约 4 字符/token，中文约 2 字符/token，取保守值 4
