...
from domain.services.snapshot_service import SNAPSHOTS_DIR, create_snapshot, preview_restore_snapshot, restore_snapshot
from shared.event_types import EVENT_SESSION_CHANGED, EVENT_SIM_ERROR, EVENT_SIM_STARTED
...
def test_session_state_manager_session_changed_event_omits_sim_result_path():
    ...
    manager._get_current_state = lambda: {'sim_result_path': 'simulation_results/amp/2026-04-06_00-10-00/result.json', 'circuit_file_path': 'designs/amp.cir'}
    manager._publish_session_changed_event(action='rollback', previous_session_id='session-000')
